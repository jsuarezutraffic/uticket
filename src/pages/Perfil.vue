...
const fila = ref({
  ...
  nombreestado: "Activo",
  username: "admi",
  ultimocambiopassword: "2021-11-19T18:58:57.187",
  ultimocambiopasswordstr: "19/11/2021 18:58:57",
  ultimoaccesohuella: null,
  fechahoraregistro: "2017-08-18T07:31:53",
  ultimologinerrado: null,
  cantidadloginerrados: 0,
  diasvencimiento: -310.79391837227314,
  nombreapellido: "Administrador RoadPASS",
  nombresapellidos: "Administrador RoadPASS",
});
...
async function actualizarPerfil() {
  visible.value = true;
  await api
    .put(`cliente?id=eq.${users.value.id}`, users.value)
    .then((response) => {
      $q.notify({
        type: "positive",
