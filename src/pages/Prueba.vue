  ...
  <div>
    <q-card>
      <q-card-section>
        ...
        <p v-if="chatStore.preguntas[chatStore.indicePreguntaActual]">
        ...
        >
          <q-item
            ...
            exact
          >
            <q-item-section v-if="opcion.descripcion != undefined">{{
              opcion.descripcion
            }}</q-item-section>
            <q-item-section v-else>{{ opcion.nombre }}</q-item-section>
          </q-item>
        </q-list>
        ...
        <q-btn
          v-if="
            chatStore.indicePreguntaActual == chatStore.preguntas.length - 1
          "
...
const validateBtnSiguente = () => {
  if (
    chatStore.preguntas[chatStore.indicePreguntaActual].key == "comentario" ||
